...
def ECOC_Process(dataname, train_data, train_label, test_data, test_label, val_data,val_label, ECOC_name, matrix_folder_path):
    ...
    for k in range(len(selected_fs_name)):
        ...
        for i in range(len(selected_dataname)):
            ...
            for j in range(len(selected_ecoc_name)):
                ...
                res = ECOC_Process(selected_dataname[i], train_data, train_label, test_data, test_label,val_data,val_label,
